...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function _src_app_appComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function AppComponent_div_4_div_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AppComponent_div_4_ng_template_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var AppComponent = /*#__PURE__*/function () {
      ...
      return _createClass(AppComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.getActiveAlerts().subscribe(function (data) {
            _this.alerts = data;
            _this.loading = false;
          });
        }
        ...
        value: function getActiveAlerts() {
          return this.http.get(this.apiUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["delay"])(2000), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (response) {
            return response.features.map(function (f) {
              return {
                ...
                areas: f.properties.areaDesc.split(';').map(function (a) {
                  return a.trim();
                }),
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 2,
      consts: [[1, "app-wrapper"], ["class", "spinner-container", 4, "ngIf"], ["class", "alerts-container", 4, "ngIf"], [1, "spinner-container"], [1, "spinner"], [1, "alerts-container"], ["class", "alert-card", 4, "ngFor", "ngForOf"], ["noAlerts", ""], [1, "alert-card"], [1, "alert-meta"], [1, "alert-areas"], [1, "alert-description"], [1, "alert-footer"], [1, "no-alerts"]],
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/macuser/Documents/Personal/Projects - 2025/D3 - experiment/d3-experiment/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
